...
export default function Welcome({ auth, buzzs, flash, extras }) {
    ...
    return (
        <>
            <Head title="Emeka Must Shine" />
            <Toaster />
            <div className="w-full py-6 bg-gray-800">
                <nav className="container px-4 mx-auto max-w-8xl sm:px-6 lg:px-6">
                    <ul className="flex items-center justify-between">
                        <li>
                            <img src="public/images/logo1.png" className="w-12 h-auto md:w-14" alt="" />
                        </li>
                        <li className="text-md">
                            <div><span className="text-rose-600 text-sm md:text-2xl font-normal font-['Pacifico']">Emeka</span><span className="text-white text-sm md:text-2xl font-normal font-['Pacifico']"> must shine, <span className="text-rose-600 text-sm md:text-2xl font-normal font-['Pacifico']">You</span> must </span><span className="text-white text-sm md:text-2xl font-normal font-['Pacifico']">shine</span><span className="text-white text-sm md:text-2xl font-normal font-['Pacifico']"> too!</span></div>
                        </li>
                        <li>
            ...
            <div className="w-full py-5 bg-yellow-400">
                <div className="container px-4 mx-auto max-w-8xl sm:px-6 lg:px-6">
                <p className="text-white text-xs md:text-base font-normal font-['Inter']  invert">⚠️ Ready to join the buzz? Enter your name to shine ✨.You can click on yes to have it automatically downloaded on your device.</p>
                </div>
            </div>

           <div className="flex items-center justify-center w-full md:h-full">
           <div className="container px-4 mx-auto mt-5 max-w-8xl sm:px-6 lg:px-6">
                <div className="flex flex-col items-center gap-4 md:flex-row">
                    <div className="w-full p-5 bg-white rounded-md shadow-sm md:p-8">
                        <div className="flex flex-col justify-center md:container md:max-w-5xl">
                            <div className="flex flex-col gap-1">
                                <h1 className="w-full text-gray-800 text-2xl md:text-3xl font-bold font-['latruffe'] leading-normal">Join the buzz</h1>
                    ...
                    <div className="w-full p-5 bg-white border-red-500 rounded-md shadow-sm md:p-8">
                        <div className='max-h-[799px] overflow-y-auto'>
                            ...
                            <div className='card w-full h-full md:h-[230px] rounded-md bg-[#FACD13] text-center'>
                                        <div className="flex flex-col items-center justify-between md:justify-center py-10 md:h-[290px]">
                                            <div className="flex flex-col items-center justify-center">
                                                <span className="animate-ping text-[#E11C47] font-bold text-xl font-['latruffe']">Emeka</span>
                                                <span className="animate-ping text-[#857D35] font-['latruffe'] text-2xl drop-shadow-sm">Must<br/>Shine</span>
                                            </div>
                                            <img src="public/images/bbicon.svg" className="object-cover w-8 h-8 mt-5 rounded-md"  alt="" />
                                        </div>
                                    </div>
                                {buzzs.map((buzz, index) => (
                                    <div className='card w-full h-full md:h-[230px] rounded-md bg-[#FACD13] text-center' key={index}>
                                        <div className="flex flex-col items-center justify-between md:justify-center py-10 md:h-[290px]">
                                            <div className="flex flex-col items-center justify-center">
                                                <span className="animate-ping text-[#E11C47] font-bold text-xl font-['latruffe']">{buzz.name}</span>
                                                <span className="animate-ping text-[#857D35] font-['latruffe'] text-2xl drop-shadow-sm">Must<br/>Shine</span>
                                            </div>
                                            <img src="public/images/bbicon.svg" className="object-cover w-8 h-8 mt-5 rounded-md"  alt="" />
                                        </div>
                        ...
                        {/* empty state */}
                        {buzzs.lenght === 0 && (<div className="flex flex-col items-center justify-center">
